 ...
 */
public class ConversionFromDecimal extends AppCompatActivity implements Constants{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        inputTextView = (TextView) findViewById(R.id.decimal_input);
        outputTextView = (TextView) findViewById(R.id.output_for_decimal);
    }
    ...
    public void convertClicked(View v){
        if(screenText.length() == 0){
            Toast.makeText(this, "Can't convert invalid decimal number", Toast.LENGTH_SHORT).show();
        } else if(isValid()){
            ConversionFunctions con = new ConversionFunctions(convertDecimal, new StringBuffer(screenText));
            switch (v.getId()){
